...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DB2:DB2@db2.3oa7m.mongodb.net/?retryWrites=true&w=majority&appName=DB2")   # IF Multiple Database Is False Then Fill Only This Database Url.
